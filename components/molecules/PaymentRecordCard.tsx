...
import { FaCreditCard, FaUser, FaEnvelope, FaCalendarAlt, FaDollarSign } from 'react-icons/fa';
      ...
      <div className="space-y-3 sm:space-y-4">
        ...
        <div className="space-y-2 sm:space-y-3">
          <div className="flex items-start sm:items-center gap-2 sm:gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs text-gray-500 font-semibold uppercase">Usuario</p>
              <p className="text-sm sm:text-base font-medium text-[#0a174e] truncate">
                {payment.nombre_usuario || 'N/A'}
              </p>
            </div>
          </div>
