...
export default function HeaderComponent() {
  ...
  if (loadingAuth) {
    return (
      <header className="bg-[#0a1445] w-full font-sans border-b-[3px] border-[#b6a253] transition-all duration-300 ease-in-out">
        <div className="flex items-center max-w-[1400px] mx-auto px-4 sm:px-8 py-4 sm:py-6">
  ...
  return (
    <header className="bg-[#0a1445] w-full font-sans border-b-[3px] border-[#b6a253] transition-all duration-300 ease-in-out shadow-lg">
